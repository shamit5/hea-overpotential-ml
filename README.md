...
1. **Predict** overpotential from composition, using a validation scheme appropriate for a small dataset (Leave-One-Out CV).
2. **Explain** what drives the prediction, using SHAP and permutation importance, to surface an actionable materials-design rule rather than a black-box score.
